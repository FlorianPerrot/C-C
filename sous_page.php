<section class="sous-page">
	...
	<nav class="menu-secondaire onglets-content">
		<a><b><img src="<?php echo get_bloginfo('template_directory');?>/img/objectif.png" alt="un objectif" width="35px" height="35px"/></b><p>Objectifs</p></a>
		<a><b><img src="<?php echo get_bloginfo('template_directory');?>/img/tourisme.png" alt="le tourisme" width="35px" height="35px"/></b><p>Pôle tourisme adapté</p></a>
